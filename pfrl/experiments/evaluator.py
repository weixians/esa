...
def record_tb_stats(summary_writer, agent_stats, eval_stats, env_stats, t):
    ...
    summary_writer.add_scalar("extras/meanplusstdev", eval_stats["mean"] + eval_stats["stdev"], t, cur_time)
    summary_writer.add_scalar("extras/meanminusstdev", eval_stats["mean"] - eval_stats["stdev"], t, cur_time)
