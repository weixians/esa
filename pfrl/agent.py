    ...
    def __save(self, dirname: str, ancestors: List[Any]):
        ...
        for attr in self.saved_attributes:
            ...
            if isinstance(attr_value, AttributeSavingMixin):
                assert not any(attr_value is ancestor for ancestor in ancestors), "Avoid an infinite loop"
        ...
        for attr in self.saved_attributes:
            ...
            if isinstance(attr_value, AttributeSavingMixin):
                ...
                if isinstance(
                    ...
                    attr_value = attr_value.module
                attr_value.load_state_dict(torch.load(os.path.join(dirname, "{}.pt".format(attr)), map_location))
        ancestors.pop()
