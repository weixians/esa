...
class IQN(dqn.DQN):
    ...
    def _compute_target_values(self, exp_batch):
        ...
        target_next_maxz = target_next_tau2av(taus_prime).evaluate_actions_as_quantiles(greedy_actions)
    ...
    def _evaluate_model_and_update_recurrent_states(self, batch_obs):
        ...
        if self.recurrent:
            if self.training:
                ...
                tau2av, self.test_recurrent_states = one_step_forward(self.model, batch_xs, self.test_recurrent_states)
        else:
