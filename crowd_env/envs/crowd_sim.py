...
from crowd_env.envs.utils.info import Timeout, Collision, Danger, ReachGoal, Nothing
...
class CrowdSim:
    ...
    def reset(self, phase="test", test_case=None):
        ...
        if phase == "test":
            ...
            self.human_times = [0] * (self.dynamic_human_num if self.robot.policy.multiagent_training else 1)
        ...
        if self.config.get("humans", "policy") == "trajnet":
            ...
            if self.case_counter[phase] >= 0:
                ...
                if phase in ["train", "val"]:
                    human_num = self.dynamic_human_num if self.robot.policy.multiagent_training else 1
        ...
        #     ob.append(ObservableState(0, 0, 0, 0, 0))
        return ob
